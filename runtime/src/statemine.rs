...
parameter_typrityOfBody<KsmLocation, ExecutiveBody>>,
>;
...
impl cumulus_pallet_parachainUtil_system::Config for Runtime {
	type Event = Event;
...
pub type SignedExtra = (
	frame_system::CheckStorageSpecVersion<Runtime>,
