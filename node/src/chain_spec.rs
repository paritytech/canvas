...
pub fn testnet_authorities() -> Vec<(AuraId, GrandpaId)> {
    ...
    let initial_authorities: Vec<(AccountId, AccountId, AuraId, GrandpaId)> = vec![
        (
            ...
            hex!["7bc6fd5dc6e832b294bbf2ae21df67f990a526793a9ded12a5e54e40a5a94d1d"]
                .unchecked_into(),
        ),
        (
            ...
            hex!["88e95527362f479ebf30502db2f7d88329e034f5d77aed585042c548fa93ae01"]
                .into(),
            ...
            hex!["eb17972691ec3a7d09a316baddc8838362ade2c12a21a506d697903e16577bfd"]
                .unchecked_into(),
        ),
    ];
    initial_authorities
